...
def load_experiment_network(
    ...
    Existing APIs are reused as-is.
    """
    nodes = get_nodes(species=species, year=year, month=month)
    edges = get_edges(
        species=species,
        year=year,
        month=month,
